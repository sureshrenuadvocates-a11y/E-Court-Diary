...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900">
      {/* BACKGROUND GLOW */}
      <div className="absolute top-[-100px] left-[-100px] h-[350px] w-[350px] rounded-full bg-indigo-500/30 blur-3xl"></div>

      <div className="absolute bottom-[-120px] right-[-120px] h-[400px] w-[400px] rounded-full bg-violet-500/30 blur-3xl"></div>
          ...
          <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 p-12 text-white lg:flex">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-6 max-w-md text-lg text-indigo-100">
                Securely manage court diary records, hearings,
                districts and legal workflows from one modern
                platform.
              </p>
            </div>
            ...
            <div className="relative z-10 mt-10 space-y-5">
              <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-100">
                    Store and organize court diaries.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-100">
                    Instantly search cases and districts.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4 backdrop-blur-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-100">
                    Protected authentication and data security.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white px-8 py-10 sm:px-14 lg:px-16">
            <div className="mx-auto max-w-md">
              ...
              <div className="mb-8 flex items-center gap-3 lg:hidden">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-600 text-2xl text-white shadow-lg">
                  ⚖️
                </div>
              ...
              <div>
                ...
                <p className="mt-3 text-slate-500">
                  Access your court diary dashboard securely.
                </p>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-4 pl-12 pr-4 text-sm text-slate-900 shadow-sm transition focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-indigo-100"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-4 pl-12 pr-14 text-sm text-slate-900 shadow-sm transition focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-indigo-100"
                    />
                ...
                <button
                  type="submit"
                  className="group relative flex w-full items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 px-6 py-4 text-sm font-bold text-white shadow-xl transition duration-300 hover:scale-[1.02]"
                >
